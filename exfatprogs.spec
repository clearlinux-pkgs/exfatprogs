...
Version  : 1.2.5
Release  : 3
URL      : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.5/exfatprogs-1.2.5.tar.gz
Source0  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.5/exfatprogs-1.2.5.tar.gz
Source1  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.5/exfatprogs-1.2.5.tar.gz.asc
Source2  : 34F230FAF78E48D3.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 34F230FAF78E48D3' gpg.status
%setup -q -n exfatprogs-1.2.5
cd %{_builddir}/exfatprogs-1.2.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723145739
