...
Version  : 1.2.6
Release  : 4
URL      : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.6/exfatprogs-1.2.6.tar.gz
Source0  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.6/exfatprogs-1.2.6.tar.gz
Source1  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.6/exfatprogs-1.2.6.tar.gz.asc
...
%setup -q -n exfatprogs-1.2.6
cd %{_builddir}/exfatprogs-1.2.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732118855
