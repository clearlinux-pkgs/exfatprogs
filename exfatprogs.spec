...
Version  : 1.2.9
Release  : 7
URL      : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.9/exfatprogs-1.2.9.tar.gz
Source0  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.9/exfatprogs-1.2.9.tar.gz
Source1  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.9/exfatprogs-1.2.9.tar.gz.asc
...
%setup -q -n exfatprogs-1.2.9
cd %{_builddir}/exfatprogs-1.2.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747145244
