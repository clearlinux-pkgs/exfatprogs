...
Version  : 1.2.7
Release  : 5
URL      : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.7/exfatprogs-1.2.7.tar.gz
Source0  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.7/exfatprogs-1.2.7.tar.gz
Source1  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.7/exfatprogs-1.2.7.tar.gz.asc
...
%setup -q -n exfatprogs-1.2.7
cd %{_builddir}/exfatprogs-1.2.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738596077
