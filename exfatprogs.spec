...
Source0  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.8/exfatprogs-1.2.8.tar.gz
Source1  : https://github.com/exfatprogs/exfatprogs/releases/download/1.2.8/exfatprogs-1.2.8.tar.gz.asc
...
%setup -q -n exfatprogs-1.2.8
cd %{_builddir}/exfatprogs-1.2.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741100599
